...
public class PngjHDRScreenshot {
    ...
    public static void takeScreenshot(RenderTarget renderTarget, Consumer<ImageBuffer> consumer){
        ...
        ScreenshotColorTransformRenderer.updateColorTransformUniforms(
                colorManagementInfoProvider.getCurrentUIBrightness(Minecraft.getInstance().getWindow().getWindow()), // For UI Brightness
                colorManagementInfoProvider.getCurrentEotfEmulate(Minecraft.getInstance().getWindow().getWindow()),
